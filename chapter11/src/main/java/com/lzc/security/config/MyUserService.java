...
public class MyUserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        ...
        List<GrantedAuthority> authorityLists = null;
        if (s.equals("admin")) {
            authorityLists = AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE_ADMIN,ROLE_USER");
        } else {
            authorityLists = AuthorityUtils.commaSeparatedStringToAuthorityList("ROLE_USER");
        }
